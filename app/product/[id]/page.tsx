...
import { useParams } from "next/navigation"; // если используем Next.js routing
...
export default function ProductPage() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#F9FAF4] flex items-center justify-center">
        <p className="text-[#00796B] text-xl font-semibold">Товар не найден</p>
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-[#F9FAF4] text-[#00796B] p-6">
